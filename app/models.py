...
class Questionario(models.Model):
    ...
    desessete = models.CharField("desessete", max_length=10, choices=escolha, blank = True)
    dezoito = models.CharField("dezoito", max_length=10, choices=escolha, blank = True)
